	...
	public class Program
{
		public static async Task Main(string[] args)
	{
		...
		builder.Services.AddDbContext<ekinyald_xContext>(options =>
			options.UseSqlServer(connectionString));
			builder.Services.AddScoped(typeof(UnitTestWeb.Repository.IRepository<>), typeof(Repository<>));
